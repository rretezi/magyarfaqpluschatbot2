...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Common
{
    ...
    public static class Constants
    {
        ...
        /// Delete command.
        /// </summary>
        public const string DeleteCommand = "törlés";

        /// <summary>
        /// No command.
        /// </summary>
        public const string NoCommand = "nem";
        ...
        /// </summary>
        public const string TakeATour = "körbejárás";

        /// <summary>
        /// AskAnExpert - text that renders the ask an expert card.
        /// </summary>
        public const string AskAnExpert = "kérdezz egy szakértőt";

        /// <summary>
        /// Feedback - text that renders share feedback card.
        /// </summary>
        public const string ShareFeedback = "visszajelzés megosztása";
